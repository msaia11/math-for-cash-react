...
"Answer simple questions to earn real cash! You will be prompted to either solve the math expression, unscramble a word, or determine the next number in a sequence."

export const RULE_TEXT2 =
"You will receive a point for every correctly answered question. Half of the daily prize pool will be awarded to the player with the most points, ending at midnight Central Time. Even if you aren't the leader you still have a chance to win! Every point you earn will be entered into a drawing, with the other half of the prize pool being awarded to the player whose entry is randomly selected. The more points you have, the better your chance of winning the drawing. A video advertisement will run every 20-30 submitted answers. If you watch the ad to completion, you will be awarded 5 points. "
